...
- [9. perform stack operations using linked list](./DS/assignments/Stack-operation.c)
- [10. To represent a Sparse Matrix using linked list.](./DS/assignments/sparse-matrix.c)
- [11. Polynomial representation using linked list.](./DS/assignments/polynomial-linkedlist.c)
- [12. Array and Linked list implementations of Stack and perform operations such as push, pop and status.](./DS/assignments/stack-array-linkedlist.c)
- [13. Linked list implementation of Queue and perform operations such as enqueue and dequeue.](./DS/assignments/queue-linkedlist.c)
- [14. Linked list implementation of Circular Queue.](./DS/assignments/circular-queue-linkedlist.c)
- [15. To implement a Binary Search Tree.](./Ds/assignments/binary-search-tree.c)
- [16. To perform tree traversal operations.](./DS/assignments/tree-traversing.c)